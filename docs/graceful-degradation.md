...
### Benefits
- **Fewer user-visible failures** during API outages
...
**Expected Impact**: fewer user-visible failures during USPTO API outages —
requests with warm cache entries succeed with clearly labeled stale data
instead of erroring.
